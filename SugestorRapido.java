...
public class SugestorRapido extends SugestorBase {
    ...
    public SugestorRapido(LlmClient llmClient) {
        super(llmClient);
    }
    ...
    protected String construirPrompt(List<Ingrediente> ingredientes) {
        ...
        sb.append(". \n\n");
        sb.append("Gere 3 sugestões de receitas (preparo de até 30 minutos) usando o máximo possível desses ingredientes. As receitas precisam ser executáveis em uma cozinha doméstica \n");
